...
# -*- encoding: utf-8 -*-
# stub: soap4r-ruby1.9 0 ruby lib

Gem::Specification.new do |s|
  s.name = "soap4r-ruby1.9".freeze
  s.version = "0".freeze

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["kpoorman".freeze]
  s.date = "1980-01-02"
  s.description = "Ruby 1.9.2 compatible soap4r library".freeze
  s.email = "kjp@brightleafsoftware.com".freeze
  ...
  s.homepage = "https://github.com/noeticpenguin/soap4r-noeticpenguin".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.6.7".freeze
  s.summary = "Ruby 1.9.2 compatible soap4r library".freeze
